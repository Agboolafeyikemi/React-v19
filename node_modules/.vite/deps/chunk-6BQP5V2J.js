import {
  require_jsx_runtime
} from "./chunk-OKFMIJL7.js";
import {
  require_react_dom
} from "./chunk-N3I4643N.js";
import {
  require_react
} from "./chunk-MSFLSCBB.js";
import {
  __commonJS,
  __toESM
...
var Match = React9.memo(function MatchImpl({
  ...
  const pendingElement = PendingComponent ? (0, import_jsx_runtime6.jsx)(PendingComponent, {}) : null;
  ...
  return (0, import_jsx_runtime6.jsx)(matchContext.Provider, { value: matchId, children: (0, import_jsx_runtime6.jsx)(ResolvedSuspenseBoundary, { fallback: pendingElement, children: (0, import_jsx_runtime6.jsx)(
    ResolvedCatchBoundary,
    {
      ...
      children: (0, import_jsx_runtime6.jsx)(
        ResolvedNotFoundBoundary,
        {
          ...
          children: (0, import_jsx_runtime6.jsx)(MatchInner, { matchId })
        }
      )
    }
  ) }) });
...
var MatchInner = React9.memo(function MatchInnerImpl({
  ...
  const out = React9.useMemo(() => {
    ...
    return Comp ? (0, import_jsx_runtime6.jsx)(Comp, {}) : (0, import_jsx_runtime6.jsx)(Outlet, {});
  ...
  return (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
    out,
    router.AfterEachMatch ? (0, import_jsx_runtime6.jsx)(router.AfterEachMatch, { match, matchIndex }) : null
  ] });
});
var Outlet = React9.memo(function OutletImpl() {
  ...
  const nextMatch = (0, import_jsx_runtime6.jsx)(Match, { matchId: childMatchId });
  const pendingElement = router.options.defaultPendingComponent ? (0, import_jsx_runtime6.jsx)(router.options.defaultPendingComponent, {}) : null;
  if (matchId === rootRouteId) {
    return (0, import_jsx_runtime6.jsx)(React9.Suspense, { fallback: pendingElement, children: nextMatch });
  }
  return nextMatch;
});
...
function ClientOnly({
  ...
  return useHydrated() ? (0, import_jsx_runtime7.jsx)(import_jsx_runtime7.Fragment, { children }) : (0, import_jsx_runtime7.jsx)(import_jsx_runtime7.Fragment, { children: fallback });
}
function subscribe() {
  return () => {
  };
...
function lazyRouteComponent(importer, exportName, ssr) {
  ...
  const lazyComp = function Lazy(props) {
    ...
    if ((ssr == null ? void 0 : ssr()) === false) {
      return (0, import_jsx_runtime7.jsx)(ClientOnly, { fallback: (0, import_jsx_runtime7.jsx)(Outlet, {}), children: React10.createElement(comp, props) });
    }
...
function createLink(Comp) {
  return React11.forwardRef(function CreatedLink(props, ref) {
    return (0, import_jsx_runtime8.jsx)(Link, { ...props, _asChild: Comp, ref });
  });
}
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6BQP5V2J.js.map
